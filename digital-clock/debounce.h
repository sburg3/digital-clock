...
// Buttons connected to PD0, PD1, PD2
#define BUTTON_PORT  PORTD
#define BUTTON_PIN   PIND
#define BUTTON_DDR   DDRD
#define BTNINC_MASK (1<<PD0)
#define BTNDEC_MASK (1<<PD1)
#define BTNMODE_MASK (1<<PD2)
#define BUTTON_MASK  (BTNINC_MASK | BTNDEC_MASK | BTNMODE_MASK)
